...
- Quarter and cross-quarter days like the solstices are shown around the interior. You can toggle between an alternate set of names for these, derived from ancient european names.
